...
echo section("Third-Party AI","There are many researchers and arganisatiosn working on a wide range of open-sourced projects. These are some that I experimented with to create my own work based on their code.","images/vr.jpg");
