...
echo section("Connect 4", "<a href=connect4>Play against an AI</a> at a game of connect 4. It has trained by playing doing millions of simulations to determine the best move in a position so that it can win as quickly as possible.","images/connect4.jpg");?>
<div class="section text"><h2>Squares</h2><p>After AlphaZero's greatness at go, chess and almost every other game, I thought it would be worth putting it to the test in this classic game. Completing a squares wins a point, but can you <a href=squares>complete more than the AI</a>?</div>
<?php
