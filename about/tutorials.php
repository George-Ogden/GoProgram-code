...
<section>
    <?php image("images/learn.jpg", "Learning", "text", array("id" => "top", "text" => "<h1>Understanding Python</h1>"));  ?>
    <div class="section text">
        <h3 class="font-italic colour">"Knowledge has no value unless you share it".</h3>
    ...
    <div class="section video">
        <h2>Lesson Videos</h2>
        <?php video("https://youtube.com/embed/a4wymMoq_kc?list=PL1_riyn9sOjcKIAYzo7f8drxD-Yg9La-D") ?>
    </div>
</section>
