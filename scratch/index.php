...
echo section("Tic-Tac-Toe", "The original 3x3 game of tic-tac=toe is trivial but on a larger grid, this is no longer the case. With a 5x5 grid and the aim of getting 4 in any direction, this advanced version gives you the opportunity to <a href=/ai/tictactoe>challenge an AI</a>.","images/tictactoe.jpg");
